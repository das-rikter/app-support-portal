...
export function ViewTabs() {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-card border-b border-border -mx-6 mb-4">
      <div className="flex overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {TABS.map((tab) => (
          <button
            ...
            className={cn(
              'px-4 py-3 text-xs font-semibold border-b-2 whitespace-nowrap transition-colors',
              activeView === tab.id
                ? 'text-[#d66a06] border-[#d66a06]'
